 ...
 * See the License for the specific langduage governing permissions and
...
/**
 * Repository classs for <code>Pet</code> domain objects All method names are compliant with Spring Data naming
